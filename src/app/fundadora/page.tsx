...
const certifications = [
  ...
  },
  {
    ...
    description: 'Profissional com formação em Academia de Polícia Civil do Estado de São Paulo e com o mínimo de 25 anos de experiência em laudos periciais.',
  },
]
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white animate-fade-in-up">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold mb-6 tracking-tight">
              Nossa <span className="text-gradient-gold bg-gradient-to-r from-gold-300 via-gold-400 to-gold-300">Fundadora</span>
            </h1>
